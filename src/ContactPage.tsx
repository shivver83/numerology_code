  ...
  return (
    <div className="contact-container">
      ...
      <div className="contact-content">
        <h2>Contact Us</h2>
        <p>
          Email: <a href="mailto:nventer@gmail.com">nventer@gmail.com</a>
        </p>
        <p>
          {phoneIcon}
          Phone: <a href="tel:+917428552116">+91-7428552116</a>
        </p>
        <p>
          {locationIcon}
          Address: Sector 51, Noida, near Metro station, Hoshiarpur
        </p>
        <p>
          {instagramIcon}
          Instagram:{" "}
